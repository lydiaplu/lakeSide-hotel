...
export default function BookingSummary({ booking, payment, onConfirm, isFormValid }) {
            ...
            <div className="card card-body mt-5">
                ...
                {payment > 0 ? (
                    <>
                        ...
                        {isFormValid && !isBookingConfirmed ? getConfirmBookingHtml() : getLoadingHtml()}
                    </>
                ) : (
